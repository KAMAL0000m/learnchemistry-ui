...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    qs('#authMsg').innerHTML = `<div class="alert alert-info">Signing up...</div>`;
    ...
    try {
      ...
      if (!token) {
        qs('#authMsg').innerHTML = `<div class="alert alert-danger">Signup failed: token not received.</div>`;
        return;
      }
      ...
      qs('#authMsg').innerHTML = `<div class="alert alert-success">Signup successful. Redirecting...</div>`;
